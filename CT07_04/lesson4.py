...
# menu = []
# while True:
#     food = input("What will be on the menu? ")
#     menu.append(food)
#     if food == "end":
#         break
...
# menu = ["baked potato","beetroot","carrot","cooked porkchop","cooked chicken","cooked mutton","steak","dried kelp","golden carrot","golden apple","lava chicken"]
# order = input("What do you want to eat? ")
# if order in menu:
#     print("Yes we sell that, please have a seat")
# else:
#     print("YOU IDIOT this is a minecraft shop not the regular resturant. GET OUT!")